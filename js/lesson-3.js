...
// const sqr = numbers.map(number => number * number);
// console.log(sqr);
...
//   { id: 3, values: [7, 8, 9] },
// ];
// const newValue = data.flatMap(value => value.values);
...
// const age = people.some(item => item.age < 20);
// console.log(age);
...
// const arr = numbers.every(number => number % 2 === 0);
// console.log(arr);
...
// const alf = stringArray.toSorted((a, b) => a.localeCompare(b));
// console.log(alf);
...
//   { name: 'Bob', age: 19 },
// ];
// const newArr = user.filter(use => use.age > 20);
// console.log(newArr);
...
// const numbers = [1, 2, 3, 4, 5];
// const add = numbers.reduce((add, number) => add + number, 0);
// console.log(add);
...
//       return this;
//     }
//     console.error('It is impossible to divide by zero!');
//     return this;
//   }
//   multiply(number) {
//     this.value *= number;
